...
<div class="col-sm-4" id="butts">
  ...
  <div class="row" id="">
      <div class="col-sm-8">
    <p class="card-text" style="color:white;"> This Section Helps to Know <strong>the report</strong></p>
</div>
<div class="col-sm-4" id="butts">
    <a href="{{url('')}}"><button type="button"  class="btn btn-light"><i class="fas fa-user"></i></button></a>
</div>
  </div>
      <div class="progress" style="height: 3px;">
  <div  class="progress-bar" role="progressbar"  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
